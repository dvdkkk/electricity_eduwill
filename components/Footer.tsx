...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-black text-zinc-500 py-12 border-t border-zinc-900 text-base">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
                <h5 className="text-white font-bold mb-4 text-lg">에듀윌 국비교육원</h5>
            ...
            <div className="md:text-right">
                ...
                <p className="text-3xl font-bold text-white">1877-5280</p>
            </div>
        </div>

        <div className="border-t border-zinc-900 pt-8 space-y-2 text-sm md:text-base">
